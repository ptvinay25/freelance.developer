...
function navmenuScrollspy() {
  ...
  let headerOffset = header ? header.offsetHeight : 70; // Default fallback
  let position = window.scrollY + 100; // Adjusted buffer
  ...
  navmenulinks.forEach(navmenulink => {
    ...
    let sectionTop = section.offsetTop - headerOffset;
...
document.addEventListener('scroll', () => {
  ...
  function sendToWhatsApp() {
    ...
    const whatsappNumber = "8152852012"; // Replace with your WhatsApp number (without '+' or spaces)
